      ...
      **********************************-->
      <div class="content-body">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl-12"> 
                        <h1 class="px-2">P2P Trade (Coming Soon)</h1>
						<div class="card">
							<div class="card-header border-0">
                               
								<h4 class="heading">Buy & Sell Bitcoin</h4>
								<nav>
									<div class="order nav nav-tabs" id="nav-tab-p2p" role="tablist">
						...
						<div class="card">
							<div class="card-body pb-0">
								<div class="d-flex flex-wrap">
									<div class="input-group custom-search-area width-300 mb-2">
										<input type="text" class="form-control" placeholder="Enter Amount">
									</div>
									<select  class="default-select form-control p2p-select width-100 mb-2" aria-label="Default" tabindex="0">
										<option>USD</option>
									...
									<select  class="default-select form-control width-200" aria-label="Default" tabindex="0">
								...
								<div class="tab-content" id="nav-tabContent1">
									<div class="tab-pane fade show active" id="nav-buy" role="tabpanel" aria-labelledby="nav-buy-tab">
										<div class="d-flex align-items-center justify-content-between">
											<h4 class="heading">P2P: Buy</h4>
											<nav>
											  <div class="order nav nav-tabs" id="nav-tab" role="tablist">
												<button class="nav-link active" id="nav-order-tab1" data-bs-toggle="tab" data-bs-target="#nav-order1" type="button" role="tab"  aria-selected="true">BTH</button>
												<button class="nav-link" id="nav-histroy-tab1" data-bs-toggle="tab" data-bs-target="#nav-history1" type="button" role="tab"  aria-selected="false">ETH</button>
												<button class="nav-link" id="nav-trade-tab1" data-bs-toggle="tab" data-bs-target="#nav-trade1" type="button" role="tab"  aria-selected="false">BNB</button>
											  </div>
											</nav>
										</div>
										<div class="tab-content" id="nav-tabContent2">
											...
											<div class="tab-pane fade" id="nav-history1" role="tabpanel">
											...
											<div class="tab-pane fade" id="nav-trade1" role="tabpanel" >
												<div class="table-responsive dataTabletrade">
                                                <table id="example" class="table shadow-hover display" style="min-width:845px">
														<thead>
															<tr>
									...
									<div class="tab-pane fade show" id="nav-sell" role="tabpanel" aria-labelledby="nav-sell-tab">
										<div class="d-flex align-items-center justify-content-between">
											<h4 class="heading">P2P: Sell</h4>
											<nav>
											  <div class="order nav nav-tabs" id="nav-tab1" role="tablist">
												<button class="nav-link active" id="nav-order-tab" data-bs-toggle="tab" data-bs-target="#nav-order2" type="button" role="tab"  aria-selected="true">BTH</button>
												<button class="nav-link" id="nav-histroy-tab" data-bs-toggle="tab" data-bs-target="#nav-history2" type="button" role="tab"  aria-selected="false">ETH</button>
												<button class="nav-link" id="nav-trade-tab" data-bs-toggle="tab" data-bs-target="#nav-trade2" type="button" role="tab"  aria-selected="false">BNB</button>
											  </div>
											</nav>
										</div>
										<div class="tab-content" id="nav-tabContent3">
											...
											<div class="tab-pane fade" id="nav-history2" role="tabpanel">
												<div class="table-responsive dataTabletrade">
                                                <table id="example" class="table shadow-hover display" style="min-width:845px">
														<thead>
															<tr>
											...
											<div class="tab-pane fade" id="nav-trade2" role="tabpanel">
												<div class="table-responsive dataTabletrade">
                                                <table id="example" class="table shadow-hover display" style="min-width:845px">
														<thead>
															<tr>
