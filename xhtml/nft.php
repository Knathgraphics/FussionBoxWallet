...
<lottie-player class="mx-auto d-block" src="https://assets7.lottiefiles.com/packages/lf20_ldq2pf6j.json"  background="transparent"  speed="1"  style="width: 100px; height: 100px;"  loop  autoplay></lottie-player>
      ...
      **********************************-->
        ...
        ***********************************-->
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl-8">
						<div class="row">
							<div class="col-xl-12">
								<div class="card bubles">
									<div class="card-body">
										<div class="buy-coin  bubles-down">
											<div>
												...
												<p class="text-italics">No Claimed NFTs, Claimed NFTs will be available here</p>
										</div>
									</div>
								</div>
							</div>
															...
															<div class="card col-11 mx-auto">
																	<div class="">
																	<img src="../img/nft 1.png"  class="img-fluid mt-4 rounded" alt="">	
																	</div>
																	<div class="card-body">
																		<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 0.2 ETH</p>

																	<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $150 Worth of Crypto to claim</p>
																	<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 1,858,754 Users</p>

																	<button class="btn mt-3 btn-primary disabled btn-block">Claim NFT</button>
															...
															<div class="card col-11 mx-auto mt-4">
																	<div class="">
																	<img src="../img/nft 2.png"  class="img-fluid mt-4 rounded" alt="">	
																	</div>
																	<div class="card-body">
																		<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 0.5 ETH</p>

																	<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $500 Worth of Crypto to claim</p>
																	<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 747,513 Users</p>
															...
															<div class="card col-11 mx-auto mt-4">
																<div class="">
																<img src="../img/nft 3.png"  class="img-fluid mt-4 rounded" alt="">	
																</div>
																<div class="card-body">
																	<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 1 ETH</p>

																<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $1,000 Worth of Crypto to claim</p>
																<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 1,392 Users</p>
														...
														<div class="card col-11 mx-auto mt-4">
															<div class="">
															<img src="../img/nft 7.png"  class="img-fluid mt-4 rounded" alt="">	
															</div>
															<div class="card-body">
																<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 1.25 ETH</p>

															<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $1,200 Worth of Crypto to claim</p>
															<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 328 Users</p>
													...
													<div class="card col-11 mx-auto mt-4">
														<div class="">
														<img src="../img/nft 8.png"  class="img-fluid mt-4 rounded" alt="">	
														</div>
														<div class="card-body">
															<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 2 ETH</p>

														<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $2,000 Worth of Crypto to claim</p>
														<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 295 Users</p>
												...
												<div class="card col-11 mx-auto mt-4">
													<div class="">
													<img src="../img/nft 9.png"  class="img-fluid mt-4 rounded" alt="">	
													</div>
													<div class="card-body">
														<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 5 ETH</p>

													<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $5,000 Worth of Crypto to claim</p>
													<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 243 Users</p>
											...
											<div class="card col-11 mx-auto mt-4">
												<div class="">
												<img src="../img/nft 12.png"  class="img-fluid mt-4 rounded" alt="">	
												</div>
												<div class="card-body">
													<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 11 ETH</p>

												<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $10,000 Worth of Crypto to claim</p>
												<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 212 Users</p>
										...
										<div class="card col-11 mx-auto mt-4">
											<div class="">
											<img src="../img/nft 10.png"  class="img-fluid mt-4 rounded" alt="">	
											</div>
											<div class="card-body">
												<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 20 ETH</p>

											<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $19,000 Worth of Crypto to claim</p>
											<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 197 Users</p>
									...
									<div class="card col-11 mx-auto mt-4">
										<div class="">
										<img src="../img/nft 11.png"  class="img-fluid mt-4 rounded" alt="">	
										</div>
										<div class="card-body">
											<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 25 ETH</p>

										<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $23,000 Worth of Crypto to claim</p>
										<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 152 Users</p>
								...
								<div class="card col-11 mx-auto mt-4">
									<div class="">
									<img src="../img/nft 13.png"  class="img-fluid mt-4 rounded" alt="">	
									</div>
									<div class="card-body">
										<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 40 ETH</p>

									<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $30,000 Worth of Crypto to claim</p>
									<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 94 Users</p>
							...
							<div class="card col-11 mx-auto mt-4">
								<div class="">
								<img src="../img/nft 14.png"  class="img-fluid mt-4 rounded" alt="">	
								</div>
								<div class="card-body">
									<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 60 ETH</p>

								<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $50,000 Worth of Crypto to claim</p>
								<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 89 Users</p>
						...
						<div class="card col-11 mx-auto mt-4">
							<div class="">
							<img src="../img/nft 15.png"  class="img-fluid mt-4 rounded" alt="">	
							</div>
							<div class="card-body">
								<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 80 ETH</p>

							<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $60,000 Worth of Crypto to claim</p>
							<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 63 Users</p>
					...
					<div class="card col-11 mx-auto mt-4">
						<div class="">
						<img src="../img/nft 16.png"  class="img-fluid mt-4 rounded" alt="">	
						</div>
						<div class="card-body">
							<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 120 ETH</p>

						<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $100,000 Worth of Crypto to claim</p>
						<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 45 Users</p>
				...
				<div class="card col-11 mx-auto mt-4">
					<div class="">
					<img src="../img/nft 17.png"  class="img-fluid mt-4 rounded" alt="">	
					</div>
					<div class="card-body">
						<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 150 ETH</p>

					<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $120,000 Worth of Crypto to claim</p>
					<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 34 Users</p>
			...
			<div class="card col-11 mx-auto mt-4">
				<div class="">
				<img src="../img/nft 18.png"  class="img-fluid mt-4 rounded" alt="">	
				</div>
				<div class="card-body">
					<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 500 ETH</p>

				<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $400,000 Worth of Crypto to claim</p>
				<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 5 Users</p>
		...
		<div class="card col-11 mx-auto mt-4">
			<div class="">
			<img src="../img/nft 19.png"  class="img-fluid mt-4 rounded" alt="">	
			</div>
			<div class="card-body">
				<p class=" p-0 m-0 text-white"> <span class="text-warning">Price: </span> <img src="./images/eth.png" width="15" alt=""> 1,050 ETH</p>

			<p class=" p-0 m-0 text-white"> <span class="text-warning">Task:</span> Deposit Upto $900,000 Worth of Crypto to claim</p>
			<p class=" p-0 m-0 text-white"> <span class="text-warning">Claimed by:</span> 2 Users</p>
	...
	<button class="btn mt-3 mb-5 btn-primary disabled col-10 d-block mx-auto ">Explore More? (Coming Soon...)</button>
