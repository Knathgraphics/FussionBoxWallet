							...
							<div class="card-body pt-2">
								...
								<form>
									...
									<div class="mt-3 d-flex justify-content-between">
										<a href="javascript:void(0)" class="btn btn-success py-2 text-uppercase disabled">BUY</a>
										<a href="javascript:void(0)" class="btn btn-danger py-2 text-uppercase disabled">Sell</a>
									</div>


<a  class="btn btn-primary disabled mx-auto d-block mt-3"> Futures Trading (Opening Soon)</a>
